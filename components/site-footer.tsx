...
export function SiteFooter() {
  return (
    <section className="container">
      <footer className="mb-4 rounded-lg border bg-white shadow dark:bg-gray-950">
        <div className="mx-auto flex w-full flex-col-reverse items-center justify-between p-4 md:flex-row">
          <span className="mt-5 flex flex-col items-center justify-center text-sm text-gray-500 dark:text-gray-400 md:mt-0 md:inline">
          ...
          <ul className="flex flex-wrap items-center justify-center text-sm font-medium text-gray-500 dark:text-gray-400">
            <li>
              <Link href="/studio" className="mr-4 hover:underline md:mr-6">
                Studio
              </Link>
            </li>
            <li>
            ...
            <li>
              <a
                href="https://discord.v3digital.studio"
                target="_blank"
                rel="noreferrer"
                className="mr-4 hover:underline md:mr-6"
              >
            ...
            <li>
              <Link href="/contact" className="hover:underline md:mr-5">
                Contact
              </Link>
            </li>
            <ModeToggle />
          ...
          <div className="mt-12 border-t border-gray-100 pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              ...
              <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
                &copy; {new Date().getFullYear()} V3 Digital Studio
              </p>
            </div>
          </div>
        </div>

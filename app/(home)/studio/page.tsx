...
import { ManSitting } from "@/components/svg"

export default function Studio() {
  return (
    <section className="container py-12 md:py-24">
      <div className="mx-auto">
        <div className="mx-auto mb-20 max-w-4xl px-8 text-start">
          ...
          <p className="mb-10 text-lg tracking-tight">
            V3 Digital Studio is a web development and design studio that
            delivers exceptional experiences on the web. We specialize in
            providing our clients with custom, high quality solutions utilizing
          ...
          <p className="m-10 max-w-xl text-xl tracking-tight">
            <span className="font-semibold italic text-muted-foreground">
              {" "}
              We design and create extremely simple, performant, highly
              adaptive, responsive web experiences that convert visitors into
              clients.{" "}
            </span>
          </p>
